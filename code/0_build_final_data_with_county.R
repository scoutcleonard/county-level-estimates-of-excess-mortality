...
## load data ----
dat_xc <- read_csv(here::here("raw_data/2022_all_cause_mortality_provisional.csv"))

dat_og <- read_csv(paste0(datapath, "fitted_and_actual_deaths_county_sets_2020_W2020_wash_6_3.csv"))
#   
#   #paste0(datapath, "fitted_and_actual_deaths_county_sets_2020_W2020_wash_6_3.csv"))
#   #here::here("raw_data/2022_all_cause_mortality_provisional.csv"))
# 
